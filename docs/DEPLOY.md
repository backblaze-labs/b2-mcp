...
| **Secret-producing tools** | `b2_create_key`, `b2_create_group_member`, and `b2_reserve_trial_create_account` are not registered until a reviewed out-of-band secret sink exists.                                                                                        | excluded          |
