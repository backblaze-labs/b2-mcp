...
| ---------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| `B2_DESTRUCTIVE_POLICY`                                          | `confirm`          | Server-side gate on destructive tools: `confirm` (MCP form elicitation on capable clients with a server-bound challenge; otherwise `confirm: true`), `block` (refuse directly), `allow` (disable this gate and skip elicitation) |
