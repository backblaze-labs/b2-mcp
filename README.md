...
| ---------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| `B2_DESTRUCTIVE_POLICY`                                          | `confirm`          | Server-side gate on destructive tools: `confirm` (MCP elicitation accept on capable clients; otherwise `confirm: true`), `block` (refuse), `allow` (disable this gate) |
